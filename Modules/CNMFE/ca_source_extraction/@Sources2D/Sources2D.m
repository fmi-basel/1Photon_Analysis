classdef Sources2D < handle
    ...
    methods
        ...
        ind_del = viewNeurons2(obj, ind, Cn, ind2, C2, folder_nm); % Added this for easier sorting of cells, adds the location on correlation image
        ...
        function Coor = get_contours(obj, thr, ind_show)
            ...
            for i = 1:5
                Indices = find(cellfun(@isempty, Coor));
                ...
                for m=1:size(Indices, 1)
                    ...
                    A_temp = obj.reshape(full(A_(:, Indices(m))),2);
    ...
    %                     continue
                        ...
                        temp = medfilt1(temp')';
                        temp(:, 1) = temp(:, end);
                        Coor{Indices(m)} = bsxfun(@plus, temp, [cmin-1; rmin-1]);
                    end
